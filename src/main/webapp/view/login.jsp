      ...
      <div class="col-12 col-md-6 hero-left">
        <div class="d-flex text-bg-primary">
          <div class="col-12 col-xl-9">
            <img class="img-fluid rounded mb-4" loading="lazy" src="../image/shoes3.png" width=70% alt="ShoeStore Logo">
            <hr class="border-primary-subtle mb-4">
            <h2 class="h1 mb-4">Chúng tôi đồng hành cùng bạn qua từng bước chân. Đăng nhập để chọn giày cho hành trình mới!</h2>
            <div class="text-end">
