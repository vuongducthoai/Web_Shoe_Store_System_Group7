...
import dao.Impl.PromotionProductDAOImpl;
...
public class PromotionProductServiceImpl implements IPromotionProductService {
    private final PromotionProductDAOImpl promotionProductDAO = new PromotionProductDAOImpl();
    ...
    public List<ProductDTO> getProductByName(List<String> productName) {
        ...
        for(String name:productName){
            ...
            listProduct.addAll(productDAO.findByName(name));
        }
        return listProduct;
    ...
    public boolean InsertPromotionProduct(PromotionDTO promotion,List<String> productName) {
      ...
      boolean  check = promotionDAO.addPromotion(promotionEntity);
        ...
        for (ProductDTO product : list) {
            ...
            check = promotionProductDAO.addPromotionProduct(promotionProduct);
            if (!check) {
    ...
    {
        return promotionProductDAO.getAll();
    }
}
