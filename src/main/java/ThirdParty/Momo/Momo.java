...
public class Momo {
    ...
    public  String extraData(List<CartItemDTO> items,int idUser){
    ...
    public JSONObject jsonKey(String requestId,int amount,String orderId,List<CartItemDTO> items,int idUser) {
        String signature ="accessKey=F8BBA842ECF85&amount="+amount+"&extraData=" +extraData(items,idUser)+
    ...
    public HttpResponse<String> CallApi(List<CartItemDTO> items,int idUser,int amount){
        ...
        HttpRequest request = HttpRequest.newBuilder()
                ...
                .POST(HttpRequest.BodyPublishers.ofString(jsonKey(id,amount, id,items,idUser).toString()))
